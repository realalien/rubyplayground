...
=end
  ...
  #XinminDailyCollector.delete_daily_news_from_db(2013, 7, 15)
   ...
   #XinminDailyCollector.save_daily_news_to_db(2014, 2, 13 ,force_reload_articles=true, get_content=true,verbose=true)
  #XinminDailyCollector.save_news_to_db_by_range("2014-1-1","2014-2-7")    # collected: "2013-3-1"to"2013-5-31",2013-6-1to2013-9-24,
  #puts "All done!"
  #
  
  
  XinminDailyCollector.util_listing_news_for_date(2014, 3, 14)
